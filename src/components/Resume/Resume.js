...
const Resume = () => {
    ...
    if (labels.education == true) {
        ...
        description = <div className="box resume-right">
            <div className="column">
                <div>
                    ...
                    <div><ProgressBar width='200px' baseBgColor='tomato' bgColor='black' borderRadius='none'  completed={80} customLabel=" " /></div>
                </div>
                <div>
                    <div style={{display:'flex'}}>
                        <div className='disc-label'><img src={disc} alt="" /> </div>
                ...
                <div>
                    ...
                    <div><ProgressBar width='200px' baseBgColor='tomato' bgColor='black' borderRadius='none' completed={85} customLabel=" " /></div>
                </div>
                <div>
                    <div style={{display:'flex'}}>
                        <div className='disc-label'><img src={disc} alt="" /> </div>
                    ...
                    <div><ProgressBar width='200px' baseBgColor='tomato' bgColor='black' borderRadius='none' completed={40} customLabel=" " /></div>
                </div>
                <div>
                    <div style={{display:'flex'}}>
                        <div className='disc-label'><img src={disc} alt="" /> </div>
                    ...
                    <div><ProgressBar width='200px' baseBgColor='tomato' bgColor='black' borderRadius='none' completed={20} customLabel=" " /></div>
                </div>
            </div>
            <div className="column">
            <div>
                    ...
                    <div><ProgressBar width='200px' baseBgColor='tomato' bgColor='black' borderRadius='none' completed={70} customLabel=" " /></div>
                </div>
                <div>
                    <div style={{display:'flex'}}>
                        <div className='disc-label'><img src={disc} alt="" /> </div>
                    ...
                    <div><ProgressBar width='200px' baseBgColor='tomato' bgColor='black' borderRadius='none' completed={50} customLabel=" " /></div>
                </div>
                <div>
                    <div style={{display:'flex'}}>
                        <div className='disc-label'><img src={disc} alt="" /> </div>
        ...
        description = <ul className="resume-right">
            <li className='li-item' style={{ marginTop: '5px' }}>
                <div className='disc-label'><img src={disc} alt="" /> hjgg</div>
                <div className='year'>2017 - 2021</div>
            </li>
            <ul>
                <li className='sub-li'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores, voluptate!</li>
